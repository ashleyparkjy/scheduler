...
(** [get_hour a n t] is the list of events that represents all events in
    schedule [t] occuring during the hour [n]. *)
val get_hour: event list -> int -> event list -> event list
